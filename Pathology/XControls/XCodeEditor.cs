...
namespace Pathology 
{
    class XCodeEditor : System.Windows.Forms.RichTextBox
    {
        public XCodeEditor()
        {
            this.Settings.Keywords.Add("select");
            this.Settings.Keywords.Add("from");
            this.Settings.Keywords.Add("case");
            this.Settings.Keywords.Add("when");
            this.Settings.Keywords.Add("then");
            this.Settings.Keywords.Add("else");
            this.Settings.Keywords.Add("end");
            this.Settings.Keywords.Add("and");
            this.Settings.Keywords.Add("if");

            this.Settings.Comment = "--";

            this.Settings.KeywordColor = Color.Blue;
            this.Settings.CommentColor = Color.Green;
